...
{
    public static Item BALLISTIC_CARTRIDGE = new BaseCraftingItem("ballistic_cartridge", 1, new FabricItemSettings()).group(MeatWeapons.WEAPONS);
    public static Item ENGINE = new BaseCraftingItem("engine", 0, new FabricItemSettings()).group(MeatWeapons.WEAPONS);
...
//    public static Item BLASTER = new BlasterItem();
    ...
    public static Item ASSAULT_DRILL = new AssaultDrillItem("assault_drill", 1000, new FabricItemSettings()).group(MeatWeapons.WEAPONS);
}
