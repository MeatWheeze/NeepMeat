...
import com.neep.assembly.BoatTest;
...
public class BoatTestRenderer extends EntityRenderer<BoatTest>
{
    public BoatTestRenderer(EntityRendererFactory.Context ctx)
    {
        super(ctx);
    }

    @Override
    public Identifier getTexture(BoatTest entity)
    {
        return null;
    }

    public void render(BoatTest entity, float yaw, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light)
    {
//        matrices.push();
