...
{
    MEAT_STEEL(MiningLevels.DIAMOND, 1500, 7.0F, 2F, 14, () -> Ingredient.ofItems(NMItems.MEAT_STEEL_INGOT)),
    EMBOSSED_MEAT_STEEL(MiningLevels.DIAMOND, 1500, 7.0F, 2F, 22, () -> Ingredient.ofItems(NMItems.MEAT_STEEL_INGOT))
