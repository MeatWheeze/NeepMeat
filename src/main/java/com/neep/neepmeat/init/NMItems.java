...
//    public static Item TANK_MINECART = new TankMinecartItem("tank_minecart", new FabricItemSettings().maxCount(1).group(NMItemGroups.GENERAL));
    ...
    public static Item BLOOD_BUBBLE = new BaseCraftingItem("blood_bubble", 1, new FabricItemSettings().food(NMFoodComponents.BLOOD_BUBBLE)).group(NMItemGroups.FOOD);
    ...
    // MEAT
    public static Item MEAT_SCRAP = new BaseCraftingItem("meat_scrap", 0, new FabricItemSettings().food(NMFoodComponents.MEAT_SCRAP)).group(NMItemGroups.FOOD);
    public static Item RAW_MEAT_BRICK = new BaseCraftingItem("raw_meat_brick", 0, new FabricItemSettings().food(NMFoodComponents.MEAT_BRICK)).group(NMItemGroups.FOOD);
    public static Item COOKED_MEAT_BRICK = new BaseCraftingItem("cooked_meat_brick", 0, new FabricItemSettings().food(NMFoodComponents.COOKED_MEAT_BRICK)).group(NMItemGroups.FOOD);
...
//    public static Item GANGLIAL_CENTRE = new BaseCraftingItem("ganglial_cluster", 1, new FabricItemSettings().group(NMItemGroups.INGREDIENTS));
    ...
    public static Item ENLIGHTENED_BRAIN = new BaseCraftingItem("enlightened_brain", 2, new FabricItemSettings().food(NMFoodComponents.ENLIGHTENED_BRAIN)).group(NMItemGroups.INGREDIENTS);
...
//    public static Item DIVINE_ORGAN = new BaseCraftingItem("divine_organ", 0, new FabricItemSettings().group(NMItemGroups.INGREDIENTS));
    ...
    public static Item WHISPER_BREAD = new BaseCraftingItem("whisper_bread", 0, new FabricItemSettings().food(NMFoodComponents.WHISPER_BREAD)).group(NMItemGroups.FOOD);
    {
//        @Override
...
//        }
    ...
    public static Item TABLET = ItemRegistry.queueItem(new ProjectorItem("projector", new FabricItemSettings().maxCount(1)).group(NMItemGroups.GENERAL));

    public static Item PIPETTE = ItemRegistry.queueItem(new PipetteItem("pipette", TooltipSupplier.hidden(3), new FabricItemSettings().maxCount(1)).group(NMItemGroups.GENERAL));

    public static Item PINKDRINK = new BaseCraftingItem("pinkdrink", 1, new FabricItemSettings().food(NMFoodComponents.PINKDRINK)).group(NMItemGroups.FOOD);
    ...
    public static Item MEAT_CARTON = ItemRegistry.queueItem(new MeatCartonItem("meat_carton", TooltipSupplier.blank(), new FabricItemSettings().food(NMFoodComponents.MEAT_CARTON)).group(NMItemGroups.FOOD));
    ...
    {
//        NMItemGroups.queueItems(NMItemGroups.GENERAL,
//            TABLET, PIPETTE, MEAT_STEEL_BOOTS, MEAT_STEEL_LEGS, MEAT_STEEL_CHESTPLATE
//                                );

//        NMItemGroups.queueItem(NMItemGroups.INGREDIENTS,
//            ANIMAL_HEART,
//                               );
    }
}
