...
public class SHLInstruction implements Instruction
{
    private final int shift;

    public SHLInstruction(int shift)
    {
        this.shift = shift;
    }

    public SHLInstruction(Supplier<World> world, NbtCompound nbt)
    {
    ...
    public static ParsedInstruction parser(TokenView view, ParsedSource parsedSource, Parser parser) throws NeepASM.ParseException
    {
        ...
        {
            program.addBack(new SHLInstruction(shift));
        };
    }
}
