...
public class WorkFluid extends RealisticFluid
{
    @Override
    public Fluid getStill()
    {
        return NMFluids.STILL_WORK_FLUID;
    }

    @Override
    public Fluid getFlowing()
    {
        return NMFluids.FLOWING_WORK_FLUID;
    }

    @Override
    public Item getBucketItem()
    {
        return NMFluids.WORK_FLUID_BUCKET;
    }

    @Override
    protected BlockState toBlockState(FluidState fluidState)
    {
        return NMFluids.WORK_FLUID.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(fluidState));
    }
...
//        }
    ...
    public static class Flowing extends WorkFluid
    {
        @Override
    ...
    public static class Still extends WorkFluid
    {
        @Override
        public int getLevel(FluidState fluidState)
        {
