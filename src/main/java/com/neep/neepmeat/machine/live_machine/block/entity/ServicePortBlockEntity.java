...
public class ServicePortBlockEntity extends BlockEntity implements LivingMachineComponent
{
    public ServicePortBlockEntity(BlockEntityType<?> type, BlockPos pos, BlockState state)
    {
