...
public class AlloyKilnBlockEntity extends SyncableBlockEntity implements Heatable, NamedScreenHandlerFactory
{
    ...
    {
        return this.currentRecipe != null || MeatlibRecipes.getInstance().getFirstMatch(NMrecipeTypes.ALLOY_SMELTING, storage).isPresent();
    }
    ...
    {
        return Text.translatable("container." + NeepMeat.NAMESPACE + ".alloy_kiln");
    }
