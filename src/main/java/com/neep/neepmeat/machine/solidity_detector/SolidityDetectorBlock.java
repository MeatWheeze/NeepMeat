...
public class SolidityDetectorBlock extends BaseFacingBlock implements BlockEntityProvider
{
    ...
    public SolidityDetectorBlock(RegistrationContext ctx, ItemSettings itemSettings, Settings settings)
    {
        super(ctx, itemSettings, settings.nonOpaque().solidBlock(SolidityDetectorBlock::never));
