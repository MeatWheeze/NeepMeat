...
import com.neep.neepbus.client.instance.LinearLeverInstance;
import com.neep.neepbus.client.instance.VerticalGaugeInstance;
...
public class NMInstances
{
    public static void init()
    {
        ...
        InstancedRenderRegistry.configure(NeepBus.VERTICAL_GAUGE_BE).alwaysSkipRender().factory(VerticalGaugeInstance::new).apply();
        InstancedRenderRegistry.configure(NeepBus.LINEAR_LEVER_BE).alwaysSkipRender().factory(LinearLeverInstance::new).apply();
