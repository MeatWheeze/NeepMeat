...
public class LimiterValveScreen extends HandledScreen<LimiterValveScreenHandler>
{
    ...
    protected static final TranslatableText RATE = new TranslatableText("screen." + NeepMeat.NAMESPACE + ".limiter_valve.text.rate");
    protected static final TranslatableText UNIT = new TranslatableText("screen." + NeepMeat.NAMESPACE + ".limiter_valve.text.unit");
    protected static final TranslatableText DROPLET_MODE = new TranslatableText("screen." + NeepMeat.NAMESPACE + ".limiter_valve.text.droplet");
    protected static final MutableText DROPLET_MODE_INFO = new TranslatableText("screen." + NeepMeat.NAMESPACE + ".limiter_valve.text.droplet_info").formatted(Formatting.GRAY);
    protected static final TranslatableText MB_MODE = new TranslatableText("screen." + NeepMeat.NAMESPACE + ".limiter_valve.text.mb");
    protected static final MutableText MB_MODE_INFO = new TranslatableText("screen." + NeepMeat.NAMESPACE + ".limiter_valve.text.mb_info").formatted(Formatting.GRAY);
