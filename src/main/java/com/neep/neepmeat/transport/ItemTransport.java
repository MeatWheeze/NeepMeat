...
public class ItemTransport
{
    ...
    public static BlockEntityType<StorageBusBlock.SBBlockEntity> STORAGE_BUS_BE;
    public static BlockEntityType<ItemRequesterBlock.IRBlockEntity> ITEM_REQUESTER_BE;
    ...
    public static void init()
    {
        ...
        STORAGE_BUS_BE = NMBlockEntities.registerBlockEntity("storage_bus", StorageBusBlock.SBBlockEntity::new, STORAGE_BUS);
        RoutablePipe.LOOKUP.registerSelf(STORAGE_BUS_BE);
        ITEM_REQUESTER_BE = NMBlockEntities.registerBlockEntity("item_requester", ItemRequesterBlock.IRBlockEntity::new, ITEM_REQUESTER);
