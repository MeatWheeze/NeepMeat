...
public class StopValveBlock extends AbstractAxialPipe implements ISpecialPipe, BlockEntityProvider
{
    ...
    {
        return state.get(OPEN) ? FilterFunction::identity : FilterFunction::zero;
    }
